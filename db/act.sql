...
INSERT INTO `act`.`act_ge_property` (`NAME_`, `VALUE_`, `REV_`) VALUES ('cfg.execution-related-entities-count', 'false', 1);
INSERT INTO `act`.`act_ge_property` (`NAME_`, `VALUE_`, `REV_`) VALUES ('next.dbid', '1', 1);
INSERT INTO `act`.`act_ge_property` (`NAME_`, `VALUE_`, `REV_`) VALUES ('schema.history', 'create(7.0.0.0)', 1);
INSERT INTO `act`.`act_ge_property` (`NAME_`, `VALUE_`, `REV_`) VALUES ('schema.version', '7.0.0.0', 1);
