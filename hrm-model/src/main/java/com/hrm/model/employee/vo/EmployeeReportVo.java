...
/**
 * @Author: 敬学
 * @CreateTime: Created in 2022-04-15 00:13
 * @Description: 员工报告vo
 */
@Getter
@Setter
...
public class EmployeeReportVo implements Serializable {
    private static final long serialVersionUID = -4813583749072828042L;
    ...
    public EmployeeReportVo(UserCompanyPersonal personal, Resignation resignation) {
