...
/**
 * @Author: 敬学
 * @CreateTime: Created in 2022-04-22 09:00
 * @Description:
 */
@Entity
@Data
@NoArgsConstructor
@AllArgsConstructor
public class AttendanceReportMonthlyBO implements Serializable {

    private static final long serialVersionUID = -2798238831635659997L;
