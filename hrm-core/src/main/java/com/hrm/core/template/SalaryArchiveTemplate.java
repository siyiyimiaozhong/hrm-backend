...
/**
 * @Author: 敬学
 * @CreateTime: Created in 2022-04-25 09:22
 * @Description: 薪酬模板
 */
@Data
@AllArgsConstructor
@NoArgsConstructor
public class SalaryArchiveTemplate implements Serializable {
    private static final long serialVersionUID = -6226659348829988408L;
